...
final class CustomSwitch: UIControl {
    ...
    @IBInspectable  public var onTintColor: UIColor = #colorLiteral(red: 0.9249405265, green: 0.9250735641, blue: 0.9249115586, alpha: 1) {
        didSet {
            self.setupUI()
    ...
    @IBInspectable public var offTintColor: UIColor = #colorLiteral(red: 0.9249405265, green: 0.9250735641, blue: 0.9249115586, alpha: 1) {
        didSet {
            self.setupUI()
        }
    }
    ...
    // thumb properties
    @IBInspectable public var thumbTintColor: UIColor = #colorLiteral(red: 0.2256926, green: 0.3269798756, blue: 0.6443627477, alpha: 1) {
        didSet {
